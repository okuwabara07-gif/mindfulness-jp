...
const TOPIC = '瞑想・マインドフルネス・ストレス解消';
const CRITERIA = '効果・続けやすさ・使いやすさ・コスパ・口コミ';
const A8_NAME = 'LAVA ホットヨガ';
const A8_URL = 'https://px.a8.net/svt/ejp?a8mat=4AZR8U+DGLC7E+3HM8+614MN';
const A8_DESC = '全国展開の人気ホットヨガスタジオ';
